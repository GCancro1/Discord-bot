...
winner_outfile = "winners.txt"
ranking_outfile = "power_ranking.txt"
# Find your league
...
print(f"writing winners string: {print_str} to {winner_outfile}")
with open(winner_outfile, "w") as f:
    f.write(print_str)
...
print(pr_str)
print(f"writing winners string: {pr_str} to {ranking_outfile}")
with open(ranking_outfile, "w") as f:
    f.write(pr_str)
